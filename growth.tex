...
We have collected well-documented information about individual computers present in New Zealand during the period under study, but at best it is a small sample of the market. At the time of writing, we have identified 78 {\bf TBC} machines (including programmable calculators) with arrival dates up to 1974, but the estimated total in that year was 280. Many of the earlier machines had of course been scrapped by then, so our sample certainly covers less than 25\% of the market. The distribution of this sample across manufacturers is shown in the following table. (The total for the British companies that ended up as part of ICL is 27, quite comparable with the total for IBM.)
...
This section has described how computers were imported, housed, installed and operated during the period of study. We will now consider what they were used for.
...
1963 & Electronic Data Systems Ltd & Auckland, Wellington, Christchurch & 50\% EELM, 50\% NZ Truth (until 1968)\\\hline 
1965 & Computer Bureau Ltd & Christchurch & Renamed Datacom, bureaus nationwide\\\hline
...
In 1958, Progeni, the first software house in NZ - \url{https://history.itp.nz/part-2/harpham.html}
