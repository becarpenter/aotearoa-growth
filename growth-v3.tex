...
\begin{abstract}This article examines whether New Zealand's geographic isolation, small domestic market, and post-colonial economic structure shaped the adoption of electronic computing between 1960 and 1975, and if this produced outcomes different from those in other countries. Drawing on archival sources, contemporary reports, and a compiled dataset of computer installations, we analyze patterns of growth, institutional development, and examples of local ingenuity.
Import controls and limits on foreign exchange strongly influenced early adoption, encouraging shared use through service bureaus and slowing overall growth.
We compared New Zealand with several other developed countries to establish whether there were any grounds for claims of exceptionalism during the early spread of modern computing. Our findings show that New Zealand's experience largely followed that of other countries and, rather than being exceptional, tended to lag behind comparable economies. By placing New Zealand alongside these countries, this study contributes to a clearer comparative understanding of early computing history.
...
New Zealand was then a relatively isolated and small though successful economy \cite{Easton-2020},
with a growing population of about 2.5 million.

This article asks two related questions: whether New Zealand's particular economic and
social setting shaped the adoption of computing differently compared to other countries,
and whether computing in turn had distinctive effects on New Zealand's post-colonial society.
More broadly, we examine whether New Zealand's early experience of computing supports
claims of national exceptionalism, which are
often made in other areas of its history~\cite{Frykberg-2025}.

To address these questions, we analyze patterns of adoption, institutional development,
and public discussion, drawing on contemporary sources, archival material, and a compiled
dataset of computer installations. We find that, although factors such as import controls and
foreign-exchange constraints influenced the timing and organization of adoption, New Zealand's
experience largely followed that of several other countries, both ex-colonies and long-established
nations, but noticeably lagged behind comparable economies.

The period from 1960 to the mid-1970s provides a natural frame for this study.
Britain's entry into the European Economic Community in 1973 marked a decisive shift in
%%\cbstart
New Zealand's economic orientation. This coincided with the first global oil price shock and the
collapse of the wool market \cite{Easton-2020}, ending an era of comfortable post-colonial prosperity.
%%\cbend
Developments such as the introduction of a national police computer system and the spread
of minicomputers after 1975 signaled the growing visibility and changing role of computing.
During the earlier period, computers were largely confined to government, business, and research
institutions, and their broader social impact was limited.

By examining this formative period, the article contributes to a comparative understanding
of early computing, placing New Zealand alongside other countries and assessing similarities
and differences. As a basis for this, we start by presenting factual material on various aspects,
sourced from contemporary accounts, existing historical studies, and recollections of participants:
...
In the years we are studying, New Zealand’s economy was initially prosperous,
but it entered a period of change as the affluence of the post-war period faltered due to the collapse of the wool market, leading to a period of stagnation and the reinforcement of stringent import controls \cite{Easton-2020}.
Britain's significance as a global power
was diminishing and New Zealand began to align its foreign policy more with the USA and Australia.
We consider the economic importance of computing, and its impact on society, during this time of change. Finally, we compare New Zealand with several other developed countries, to look for evidence of any unique properties. After fifteen years of computing, was New Zealand lagging or leading by comparison with its peers?

\vspace*{-8pt}
\section{GROWTH IN NUMBERS AND EMPLOYMENT}
Like other developed countries, early forms of information technology had appeared in New Zealand during the first half of the 20th century, but were of limited importance in its largely agricultural economy \cite{pioneers}.
...
For example, in the financial year 1966/67 requests to import computers totalled over NZ£2,000,000 in value but only NZ£400,410 was available \cite{Treasury-1966}. Priority was given to companies which brought in the most foreign exchange. This had a major effect on the adoption of computing, especially since the Treasury initially favored computing service bureaus to ensure maximum usage of what they considered a scarce resource. Of course, many companies would have much preferred to have their own systems.
...
31 women, i.e. 27\%) by 1974 \cite{Yearbook75}. Overall, some 4000 data processing staff were then employed at  220 sites -- 39\% in Wellington, 31\% in Auckland, 9\% elsewhere in the North Island, and 21\% in the South Island \cite{Beardon}. Pay was attractive: in 1967, an EDP manager’s average annual salary was NZ\$4580 \cite{ScottSurvey1967}, when the national average for company directors and managers was NZ\$4220 \cite{Yearbook70}. Programmers and systems analysts earned anywhere between NZ\$2000 and NZ\$4000. 
...
Even if the public services had 27\% of female staff, it is not clear that the same applied elsewhere.
...
These statistics reflect trends in wider society; despite New Zealand being the first self-governing country to give women voting rights in 1893, in 1972 only four MPs out of 87 were female and none were in the Cabinet. \cite{Easton-2020}.
...
The main British competitor in 1960 was ICT, but any potential customer would certainly have been confused by the fragmented state of the British computer industry at that time \cite{Hendry-1989}.
Nevertheless, ICT sold one ICT 1201, at least six ICT 1301s, and numerous machines from the ICT 1900 series.
It was not until the various British companies were unified as ICL in 1968 that things settled down, but by then IBM had the lion’s share of the New Zealand market and ICL was falling behind. In 1974, the new ICL 2900 series had to compete with the well established and upwardly compatible IBM 360 series.

Other companies that were active in the early days were Burroughs (with its E2000, a computer specialized for accounting), and NCR (Series 500, also specialized for ledgers). Another factor was that in 1967, New Zealand moved from sterling pounds, shillings and pence to decimal dollars. This conversion accelerated the adoption of computer equipment, with the Decimal Currency Board providing NZ£91,500 in grants for organizations to switch from programmable calculators to computers \cite{Treasury-1966}. This subtly affected the market, since British vendors lost the advantage of their expertise in supporting pounds, shillings and pence. Even Olivetti entered the New Zealand market around 1970 with their compact and elegantly designed Programma series, aimed at smaller businesses \cite{Taupo-Olivetti-1970}. 

We collected available information about individual computers present in New Zealand during the period under study from a
variety of sources, using formal publications, personal communications, photographic archives, sundry web pages, press reports and at
%%\cbstart
least one student newspaper. However, at best these data cover a small sample of the market.
%%\cbend
The details are available on-line as a spreadsheet \cite{SpreadsheetNZ}.
At the time of writing, we have identified more than 80 machines (including programmable calculators) with arrival dates up to 1975. Since the total number of computers installed in 1975 exceeded 280 (see Table~\ref{TotalComp}), and many earlier machines had been scrapped by then, our sample certainly captures less than 25\% of the market. The distribution of this sample across manufacturers is shown in Table~\ref{TotalManuf}. The total for the British companies that ended up as part of ICL is 29, similar to the total for IBM. It is clear that American suppliers had become dominant, largely overcoming New Zealand’s traditional leaning towards the UK.
\begin{table}[h]
\begin{center}
\begin{tabular}{ |c|c| } 
 \hline
...
\end{table}
%%\cbstart
The first bureau listed remains  poorly documented. According to ICT’s records in the UK, it bought an ICT 1301 for “service work”
\cite{ccs-t2x1}, but we have found no local records to substantiate this, beyond the formal records of the formation and dissolution of the company. Another  poorly documented bureau hosted the government Education Department’s second computer, also an ICT 1301, leased from ICT at the end of 1963 and installed in ICT premises in Wellington. At its inauguration, the Minister of Education pressed a button to activate the system, which he described as “New Zealand’s first computer bureau” \cite{NatEd1963},
although all indications are that it was dedicated to the Education Department. It seems that obtaining an import license for a shared bureau computer was significantly easier than for a single-user machine. The remaining bureaus are better documented, and we now present several brief case studies.
%%\cbend
...
%%\cbstart
\noindent{These developments indicate that Computer Bureau Ltd had established a successful business model. In 2026, they still prosper under the name of Datacom, claiming to be the largest technology company in New Zealand, and employing at least 6000 people at offices across the Asia-Pacific region (Figure~\ref{Datacom25}).}
%%\cbend
...
%%\cbstart
unfounded fear that they would use the Society for promotion of their products and services rather than for learning.
%%\cbend
...
%%\cbstart
In 2012, NZCS rebranded itself as Information Technology Professionals New Zealand (ITPNZ) \cite{Matthews},
%%\cbend
and was eventually liquidated in 2025 due to a financial crisis.
...
\begin{tabular}{ |m{0.07\linewidth}|m{0.23\linewidth}|m{0.23\linewidth}|m{0.23\linewidth}<{\raggedright}| } 
 \hline
 Year & University & Model & Notes\\
\hline
1962 & Canterbury, Christchurch & IBM 1620 &\\\hline
1963 & Auckland & IBM 1620* & Figure~\ref{AU-1620}\\\hline 
...
\end{tabular}
 \begin{tablenotes}
      \item[]* Preserved at the Bob Doran Museum of Computing.
 \end{tablenotes}
\vspace{1ex}
...
\end{center}
\end{table}
%% \blfootnote{\textsuperscript{\textdagger} Preserved at the Bob Doran Museum of Computing.}

\begin{figure}
\centerline{\includegraphics[width=18.5pc]{AU-1620.jpg}}
\caption{\label{AU-1620}The Auckland IBM 1620, believed to be the oldest computer on display in NZ. Courtesy Bob Doran Museum of Computing.}\vspace*{-5pt}
\end{figure}
...
As well as research, these early machines were also used for undergraduate programming courses. However, in the 1960s, computing was mainly taught as a useful skill, not as an academic subject in its own right. The discipline of Computer Science (CS) was late to arrive in New Zealand. For example, in the UK (New Zealand’s main source of academic immigrants at that time), the Mathematical Laboratory in Cambridge had offered a post-graduate Diploma in Numerical Analysis and Automatic Computing (later renamed Diploma in Computer Science) since 1953. The Department of Computer Science at the University of Manchester was founded in 1964, graduating its first students in 1968. CS departments also emerged in the USA during the 1960s. It was not until 1973 that three CS
%%\cbstart
departments were founded in New Zealand, at the University of Canterbury (led by Professor John Penny),  Massey University (led by Professor Graham Tate) and Waikato University (led by Professor Darryl Smith) \cite{Bell, Waikato-50}.
%%\cbend
...
Thus, the early decades of computing in New Zealand were marked by adaptation and experimentation; limited resources inspired technical creativity.
\vspace*{-8pt}
...
%%\cbstart
As indicated above, IBM and other American computer companies were able to expand their presence in this environment.
%%\cbend
...
healthy economy undergoing significant structural change, despite the Treasury’s continued
...
%%\cbstart
Lawyers were among the first groups to consider the social impact of computers.
%%\cbend
...
%%\cbstart
This led some years later to anti-authoritarian protests, culminating in an anarchist bombing that killed only the bomber.
%%\cbend
However, it seems that during our study period,
...
As noted above, this debate was reported in the national press, which took an active interest in NZCS activities.
\vspace*{-8pt}
...
\caption{\label{CpH}Visualizing dissemination by country.}\vspace*{-5pt}
\end{figure}
%%\cbend

%%\cbstart
Using data from Table~\ref{TotalComp}, \cite{Hendry-1989}, \cite{ACS-2017} and \cite{Australia-1974}, together with
generally available population data,  Table~\ref{CpM} compares the dissemination of computers
relative to population size
in New Zealand with that in Australia, the UK, the USA, France, West Germany and Japan. 
Figure~\ref{CpH} visualizes the same data graphically.
%%\cbend
Unsurprisingly,
...
Whatever New Zealanders might have believed at the time, objectively they
...
little role to play, allowed New Zealand to lag by a few years without serious economic consequences. Also, New Zealand lacked a defense industry of any size, a major driving factor in both the UK and the USA.
...
different in New Zealand compared to other countries. Contemporary studies are lacking, but for example
in 2021, 27\% of IT workers in New Zealand were female \cite{NZTIA-2022}, exactly the fraction mentioned above
for government computing in 1974, and between the recent UK rate of 26\% \cite{WISE-2023}
...
\vspace*{-8pt}
\section{CONCLUSION}
This article has examined how electronic computing was adopted in New Zealand between 1960 and 1975. 
%%\cbstart
Developments since 1975 have been well documented by ITPNZ \cite{ITPNZ} and by InternetNZ \cite{ConnectingClouds}.
%%\cbend
We also examined whether this process differed significantly from that in other countries. We find that, although New Zealand's geographic isolation, small domestic market, and import controls influenced the timing and organization of adoption, these factors did not produce a fundamentally distinctive pattern.

Computing spread across government, business, and academia in broadly similar ways to other developed economies, although New Zealand generally lagged behind countries such as Australia, the United Kingdom, and those in Europe and North America. The emphasis on shared computing through service bureaus and the constraints imposed by foreign-exchange controls reflected local conditions, but do not amount to strong evidence of national exceptionalism.

During this period, New Zealand itself was undergoing wider economic and social change, moving away from close dependence on the United Kingdom towards a more independent position in global trade. Computing supported this transition by enabling greater organizational efficiency and new forms of coordination, even if its broader social impact remained limited until the mid-1970s.

Overall, New Zealand's early experience of computing is best understood not as exceptional, but as part of a wider international pattern in which similar technologies were adopted, adapted, and integrated under different local constraints. Placing New Zealand alongside other countries helps clarify both the common features of early computing and the modest extent of national variation.
\vspace*{-8pt}
...
insightful comments, and to Barbara Ainsworth, Monash University, for Australian data.
Informants with relevant personal memories included Andy Bell, Tom Bell, Nevil Brownlee,
%%\cbstart
John Butcher, Neil Harsant, the late Hugh Jonkers, and Lloyd Thomas.
%%\cbend
