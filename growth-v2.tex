...
\begin{abstract}
\cbstart
This article examines whether New Zealand's geographic isolation, small domestic market, and post-colonial economic structure shaped the adoption of electronic computing between 1960 and 1975, and whether this produced outcomes different from those in other countries. Drawing on archival sources, contemporary reports, and a compiled dataset of computer installations, we analyse patterns of growth, institutional development, and examples of local ingenuity.

We show that import controls and limits on foreign exchange strongly influenced early adoption, encouraging shared use through service bureaus and slowing overall growth.

Our comparison of New Zealand with other countries, undertaken to establish whether it had any claim to exceptionalism during the early spread of modern computing, shows that New Zealand's experience largely followed that of other countries but lagged behind comparable economies. By placing New Zealand alongside these countries, this study contributes to a clearer comparative understanding of early computing history.
\cbend
\end{abstract}
...
\cbstart
This article asks two related questions: whether New Zealand's particular economic and social setting shaped the adoption of computing compared to other countries, and whether computing in turn had distinctive effects on New Zealand's post-colonial society. More broadly, we examine whether New Zealand's early experience of computing supports claims of national exceptionalism, which are sometimes made in other areas of its history~\cite{Frykberg-2025}.

To address these questions, we analyse patterns of adoption, institutional development, and public discussion, drawing on contemporary sources, archival material, and a compiled dataset of computer installations.
\cbend  %%this bizarreness works around an apparent LaTeX bug
We find that, although factors such as import controls and
\cbstart  %%this bizarreness works around an apparent LaTeX bug
foreign-exchange constraints influenced the timing and organisation of adoption, New Zealand's experience largely followed that of other countries but noticeably lagged behind comparable economies.
The period from 1960 to the mid-1970s provides a natural frame for this study.
Britain's entry into the European Economic Community in 1973 marked a decisive shift in New Zealand's economic orientation,
coinciding with the first global oil price shock and ending an era of comfortable post-colonial prosperity.
Developments such as the introduction of a national police computer system and the spread of minicomputers
after 1975 signaled the growing visibility and changing role of computing. During the earlier period, computers were largely confined to government, business, and research institutions, and their broader social impact was still emerging.

By examining this formative period, the article contributes to a more comparative understanding of early computing, placing New Zealand alongside other countries and assessing both its similarities and its differences.
As a basis for this, we start by presenting factual material on various aspects, relying on contemporary sources, existing historical studies, and the memories of some participants:
\cbend
