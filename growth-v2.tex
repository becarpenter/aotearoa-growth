...
\begin{abstract}
\cbstart
This article examines whether New Zealand's geographic isolation, small domestic market, and post-colonial economic structure shaped the adoption of electronic computing between 1960 and 1975, and if this produced outcomes different from those in other countries. Drawing on archival sources, contemporary reports, and a compiled dataset of computer installations, we analyse patterns of growth, institutional development, and examples of local ingenuity.
...
To address these questions, we analyse patterns of adoption, institutional development,
...
foreign-exchange constraints influenced the timing and organisation of adoption,
\cbend  %%this bizarreness works around an apparent LaTeX bug at end of page 1 column 1
New Zealand's
\cbstart  %%this bizarreness works around an apparent LaTeX bug at end of page 1 column 1
...
\section{CONCLUSION}
\cbstart
This article has examined how electronic computing was adopted in New Zealand between 1960 and 1975\footnote{Developments since 1975 have been well documented by ITPNZ \cite{ITPNZ} and by InternetNZ \cite{ConnectingClouds}.}, and whether this process differed significantly from that in other countries. We find that, although New Zealand's geographic isolation, small domestic market, and import controls influenced the timing and organisation of adoption, these factors did not produce a fundamentally distinctive pattern.
...
John Butcher, Neil Harsant, Hugh {Jonkers\textdagger}  and Lloyd Thomas.
\cbend
