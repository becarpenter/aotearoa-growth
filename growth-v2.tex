...
By 1960, the country had a rather centrally managed post-colonial economy. Indeed, its currency was tied to the pound sterling until as late as 1985, so the country remained somehwhat bound to the British economy. The details are complex \cite{Sullivan2013}, but the result was that during the period of our study the Treasury was always concerned about the foreign exchange impact of computer imports. This necessitated a
\cbstart
...
economies such as the USA \cite{Oliner-1994}. Nevertheless, we suggest that the kind of competitive
